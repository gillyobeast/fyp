...
that \todo{continuous functional calculus.}
...
\todo [inline]{example of $\B(\H)$ at end of section to retro-motivate notation.
				define compact operators and discuss Calkin algebra?
...
\todo[inline]{remark on different reps given by different $\S_0$s. the universal rep, the reduced atomic rep}
